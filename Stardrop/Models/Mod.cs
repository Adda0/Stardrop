...
namespace Stardrop.Models
{
    public class Mod : INotifyPropertyChanged
    {
        ...
        public string ChangeWholeModStateText { get { return IsEnabled ? Program.translation.Get("internal.disable_whole_mod") : Program.translation.Get("internal.enable_whole_mod"); } }
        ...
        public Mod(Manifest manifest, FileInfo modFileInfo, string uniqueId, string version, string? name = null, string? description = null, string? author = null)
        {
            ...
            UniqueId = uniqueId;
            Version = SemVersion.TryParse(version, SemVersionStyles.Any, out var parsedVersion) ?
                parsedVersion : SemVersion.ParsedFrom(0, 0, 0, "bad-version");
        ...
        private string ComputeModPath(FileInfo modFileInfo)
        {
            ...
            // TODO: Add program config option to sdwitch between both approaches?
            ...
            var foundIndex = modNamePath.IndexOf(System.IO.Path.DirectorySeparatorChar, StringComparison.Ordinal);
            // For subfolders-specific grouping.
            // Producing groups "automation/Automate" and "automation/Producer Framework Mod" folders as separate groups.
            // var foundIndex = modNamePath.LastIndexOf(System.IO.Path.DirectorySeparatorChar, StringComparison.Ordinal);
